...
export default function ForecastCard({ icon, day, minTem, minTem_f, maxTem, maxTem_f }) {
    ...
    return(
        <div className="flex flex-col items-center gap-1 p-2 w-24 border rounded-lg border-congress-blue-200 dark:border-river-bed-400 bg-congress-blue-100 dark:bg-river-bed-100">
