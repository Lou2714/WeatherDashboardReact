        ...
        <div className="m-1">
            <label className="relative inline-block w-16 h-8">
                <input type="checkbox" role="switch"
                    className="opacity-0 w-0 h-0 peer checked:bg-[#474f59] focus:shadow-md focus:shadow-[#474F59]" 
                ...
                <span className="absolute cursor-pointer rounded-full bg-congress-blue-100 top-0 left-0 right-0 bottom-0 transition-all transition-discrete delay-150 
                        ...
                        before:rounded-full peer-checked:bg-[#474F59] peer-checked:before:translate-x-8 peer-checked:before:bg-[#AEB5BF]">
